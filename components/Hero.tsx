      ...
      <div className="relative mt-48 z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        <div className="my-11 flex flex-wrap gap-5">
          <p className="regular-16 mt-6 bg-white/80 text-gray-30 xl:max-w-[520px]">
            Хостел «Тихий» предлагает комфортное размещение для путешественников и деловых людей. Мы находимся в центре
            города, недалеко от основных достопримечательностей и транспортных узлов.
          </p>
        </div>
      </div>
